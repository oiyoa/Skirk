...
The default `profile=auto` keeps the user-facing config simple. It uses conservative client uploads on restricted/proxied routes, higher client downloads, and higher exit-side uploads for bulk responses.
